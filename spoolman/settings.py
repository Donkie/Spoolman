...
register_setting("derived_fields_vendor", SettingType.ARRAY, json.dumps([]))
register_setting("derived_fields_filament", SettingType.ARRAY, json.dumps([]))
register_setting("derived_fields_spool", SettingType.ARRAY, json.dumps([]))
register_setting("api_include_derived_fields", SettingType.BOOLEAN, json.dumps(obj=False))
