...
register_setting("complex_fields_vendor", SettingType.ARRAY, json.dumps([]))
register_setting("complex_fields_filament", SettingType.ARRAY, json.dumps([]))
register_setting("complex_fields_spool", SettingType.ARRAY, json.dumps([]))
