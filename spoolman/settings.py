...
register_setting("applications_vendor", SettingType.ARRAY, json.dumps([]))
register_setting("applications_filament", SettingType.ARRAY, json.dumps([]))
register_setting("applications_spool", SettingType.ARRAY, json.dumps([]))
