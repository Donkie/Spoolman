    ...
    for db_item in db_items:
        ...
        if include_derived_resolved and derived_fields:
            ...
            derived_values = evaluate_derived_fields_for_scope(
                ...
                entity_id=spool_payload.id,
            )
            spool_payload = spool_payload.model_copy(update={"derived": derived_values or None})
        payload.append(spool_payload)
