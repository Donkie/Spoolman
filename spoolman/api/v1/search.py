...
@router.get(
    ...
    description=(
        ...
        "PETG-CF filaments made by Bambu Lab. Weight terms in g/kg and diameter terms in mm are "
        "compared numerically against spools and filaments; a number without a unit matches either "
        "field exactly. A purely numeric query additionally matches spool and filament ids, and a "
        "complete imported external ID matches its filament. A query that "
