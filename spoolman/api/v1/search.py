...
@router.get(
    ...
    description=(
        ...
        "compared numerically against spools and filaments; units may be omitted. A purely numeric "
        "query additionally matches a spool by its exact id. A query that "
