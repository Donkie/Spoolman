...
import { ManufacturerLogosSettings } from "./manufacturerLogosSettings";
      ...
      >
        <Menu
          ...
          items={[
            ...
            { key: "logos", label: t("settings.logo_manager.tab"), icon: <PictureOutlined /> },
            {
              key: "extra",
        ...
        <main>
          <Routes>
            ...
            <Route path="/logos" element={<ManufacturerLogosSettings />} />
