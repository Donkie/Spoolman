...
import SpoolSelectModal from "../printing/spoolSelectModal";

const { useToken } = theme;

export const SpoolLabels = () => {
  ...
  const handleNavigate = (mode: "print" | "export", ids: number[]) => {
    const params = new URLSearchParams();
    ids.forEach((id) => params.append("spools", id.toString()));
    params.set("return", selectionPath);
    navigate(`/spool/${mode}?${params.toString()}`);
  };
